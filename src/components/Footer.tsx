      ...
      <div className="container-x py-16 lg:py-24">
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="mt-5 text-[var(--color-bg)]/70 text-[15px] leading-relaxed max-w-md">
            ...
            <dl className="mt-6 space-y-1.5 font-mono text-[13px] text-[var(--color-bg)]/65">
              <div className="flex gap-3">
                <dt className="w-24 text-[var(--color-bg)]/45">sede</dt>
                <dd>{site.address.full}</dd>
              </div>
              <div className="flex gap-3">
                <dt className="w-24 text-[var(--color-bg)]/45">p.iva</dt>
                <dd>—</dd>
              </div>
            </dl>
          </div>
          ...
          <div className="lg:col-span-3">
            ...
            <div className="mt-6 font-mono text-[12px] text-[var(--color-bg)]/55 space-y-1">
              {site.hours.map((h) => (
                <div key={h.days}>
                  <span className="text-[var(--color-bg)]/40 mr-2">{h.days}</span>
                  {h.time}
                </div>
              ))}
            </div>
        ...
        <div className="mt-16 pt-6 border-t border-[var(--color-bg)]/10 flex flex-col md:flex-row md:items-center md:justify-between gap-3 font-mono text-[11px] text-[var(--color-bg)]/45">
